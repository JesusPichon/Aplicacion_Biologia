...
const InputCoordenadas = ({
  ...
  return (
    <View style={styles.container}>
      <Text style={[styles.textP, {color: colorCuaternario}]}>
        Coordenadas:
      </Text>
      ...
      {watchOption === 'geographic' && (
        <View style={styles.container}>
          <View style={styles.container}>
            <Text style={[styles.textPCoordenadas, {color: colorCuaternario}]}>
              Latitud:
            </Text>
            <Controller
              control={control}
              render={({field: {onChange, value}}) => (
                <TextInput
                  style={[
                    styles.textInputCoordenadas,
                    {borderColor: borderColor, color: colorQuinario},
                  ]}
                  onChangeText={onChange}
                  value={value}
                  placeholder="Ingrese los grados de latitud"
                  placeholderTextColor={
                    currentTheme === 'dark' ? '#FFF' : 'gray'
                  }
            ...
            />
            {errors && errors[name1] && (
              <Text style={styles.textError}>{errors[name1].message}</Text>
            )}
          </View>
          <View style={styles.container}>
            <Controller
            ...
            />
            {errors && errors[name2] && (
              <Text style={styles.textError}>{errors[name2].message}</Text>
            )}
          </View>
          <View style={styles.container}>
            <Controller
            ...
            />
            {errors && errors[name3] && (
              <Text style={styles.textError}>{errors[name3].message}</Text>
            )}
          </View>
          <View style={styles.container}>
            <Controller
              ...
              render={({field: {onChange, value, onBlur}}) => (
                <Dropdown
                  ...
                  placeholderStyle={{
                    color: currentTheme === 'dark' ? '#FFF' : 'gray',
                  }}
                  selectedTextStyle={[
          ...
          <View style={styles.container}>
            ...
            />
            {errors && errors[name5] && (
              <Text style={styles.textError}>{errors[name5].message}</Text>
            )}
          </View>
          <View style={styles.container}>
            <Controller
            ...
            />
            {errors && errors[name6] && (
              <Text style={styles.textError}>{errors[name6].message}</Text>
            )}
          </View>
          <View style={styles.container}>
            <Controller
            ...
            />
            {errors && errors[name7] && (
              <Text style={styles.textError}>{errors[name7].message}</Text>
            )}
          </View>
          <View style={styles.container}>
            <Controller
          ...
          <Text
            style={[styles.textPCoordenadasFinal, {color: colorCuaternario}]}>
            Latitud: {watch(name1)}° {watch(name2)}' {watch(name3)}"{' '}
            {watch(name4)}
          </Text>
          <Text
            style={[styles.textPCoordenadasFinal, {color: colorCuaternario}]}>
            Longitud: {watch(name5)}° {watch(name6)}' {watch(name7)}"{' '}
            {watch(name8)}
          </Text>
        </View>
      )}
      ...
      {watchOption === 'metric' && (
        <View>
          <View style={styles.container}>
            ...
            />
            {errors && errors[name9] && (
              <Text style={styles.textError}>{errors[name9].message}</Text>
            )}
          </View>
          <View style={styles.container}>
            <Controller
              ...
              rules={rules}
            />
            {errors && errors[name10] && (
              <Text style={styles.textError}>{errors[name10].message}</Text>
            )}
          </View>
          <Text
            style={[styles.textPCoordenadasFinal, {color: colorCuaternario}]}>
            X - Longitud E: {watch(name9)}
          </Text>
          <Text
            style={[styles.textPCoordenadasFinal, {color: colorCuaternario}]}>
            Y - Latitud N: {watch(name10)}
          </Text>
        </View>
      )}
    </View>
