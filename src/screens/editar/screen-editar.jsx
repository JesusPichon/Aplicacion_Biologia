    ...
    <Animated.View
      ...
      <ScrollView style={[styles.containerF, styles.fondoT]}>
        ...
        <TextInputCustom
          ...
          errors={errors}
          tooltip={
            'Escribe el color o si conoces información detallada, ponla aquí'
          }
        />
        <TextInputCustom
          label="Fruto:"
          ...
          errors={errors}
          tooltip={
            'Escribe el color, tipo, si conoces información detallada, ponla aquí '
          }
        />
        <TextInputCustom
          label="Usos:"
        ...
        <TextInputCustom
          ...
          errors={errors}
          tooltip={
            'Escribe el nombre y apellido de el colector o los colectores'
          }
        />
        <TextInputCustom
          label="No. de colecta:"
