        ...
        <View style={[styles.mainContainer, { backgroundColor: colorPrimario, }]}>
            ...
            <View style={[styles.secondaryContainer, { backgroundColor: colorSecundario, }]}>
                ...
                <Tab
                    value={index}
                    onChange={(e) => {
                        console.log(e); // Add console.log here
                        setIndex(e);
                    }}
                ...
                <TabView value={index} onChange={setIndex} animationType="spring" containerStyle={{ height: '100%' }}>
                    <TabView.Item style={[styles.TabViewcontainer, { backgroundColor: colorTerciario }]}>
                        <ScrollView>
                            <TextInputCustom
