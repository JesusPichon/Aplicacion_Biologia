...
const CamposPred = ({navigation, route}) => {
  ...
  const {colorPrimario, colorSecundario, colorQuinario} = theme;
  ...
  const onSubmit = data => {
    ...
    const areAllEmpty = Object.values(data).every(
  ...
  return (
    <View style={[styles.mainContainer, {backgroundColor: colorSecundario}]}>
      <ScrollView style={[styles.containerF, {backgroundColor: colorPrimario}]}>
        <View style={styles.containerMarginBottom}>
          ...
          <TextInputCustom
            ...
            errors={errors}
            tooltip={
              'Anota el color, si está mojado o seco y sensación al tacto'
            }
          />
        </View>
      </ScrollView>
